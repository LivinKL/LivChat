...
import 'package:dochat/pages/profile_page.dart';
import 'package:dochat/pages/search_page.dart';
import 'package:dochat/service/auth_service.dart';
import 'package:dochat/service/database_service.dart';
import 'package:dochat/widgets/group_tile.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  gettingUserData() async{
    ...
    await DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid).getUserGropus().then((snapshots) {
      setState(() {
        groups = snapshots;
      });
    });
